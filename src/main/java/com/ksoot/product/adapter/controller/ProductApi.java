...
public interface ProductApi extends Api {
  ...
  @Operation(operationId = "create-product", summary = "Creates a Product")
  @ApiResponses(
      value = {
  ...
  ResponseEntity<APIResponse<?>> createProduct(
      @Parameter(description = "Create Product request", required = true) @RequestBody @Valid
          final ProductCreationRQ request);

  @GetMapping(path = "/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(operationId = "get-product-by-id", summary = "Gets a Product by id")
  @ApiResponses(
      value = {
  ...
  ResponseEntity<ProductVM> getProduct(
      @Parameter(description = "Product Id", required = true, example = "6558c30160463a1fee00c7dc")
  ...
  @PatchMapping(
      ...
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(operationId = "update-product", summary = "Updates a Product")
  @ApiResponses(
      value = {
  ...
  ResponseEntity<APIResponse<?>> updateProduct(
      @Parameter(description = "Product Id", required = true, example = "6558c30160463a1fee00c7dc")
          @PathVariable(name = "id")
          final String id,
      @Parameter(description = "Update Product request", required = true) @RequestBody @Valid
  ...
  @Operation(operationId = "delete-product", summary = "Deletes a Product")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = SC_200,
